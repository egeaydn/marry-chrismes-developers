...
export function FinalCTASection() {
  ...
  const shareText = encodeURIComponent(
    "🎉 Just wrapped my 2025 Developer Rewind! Another year of commits, bugs, and coffee. Check out your own: [your-url]"
  );
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="px-8 py-4 bg-zinc-800 hover:bg-zinc-700 text-white font-semibold rounded-lg transition-all transform hover:scale-105 flex items-center gap-2"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://github.com/yourusername/commit-rewind"
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 bg-transparent border border-zinc-700 hover:border-cyan-500 text-white font-semibold rounded-lg transition-all transform hover:scale-105 flex items-center gap-2"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
